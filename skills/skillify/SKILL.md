...
when_to_use: "Use at the end of a session where you performed a repeatable process you want to capture as a reusable skill. Trigger phrases: '/skillify', 'turn this into a skill', 'make a skill from this', 'capture this workflow'."
...
Review this conversation carefully: the user's messages, the steps you took, where the user corrected or steered you, the final artifacts. That is the material you are compressing into a skill. Pay special attention to the user's messages and corrections — their preferences become rules in the new skill.
