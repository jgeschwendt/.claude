...
Applies to any script run by Bun (`#!/usr/bin/env bun`, skill scripts). The statusline and the format hook are Rust binaries built from the crate at `~/.claude`, not Bun scripts.
